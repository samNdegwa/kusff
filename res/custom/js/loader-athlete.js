function loadAcademic() {
    $.get('widget/registration/academics.php', function (data, status) {
        $('#form-area').fadeOut(300, function () {
            $(this).html(data).fadeIn(300);
            $('html, body').wait(0).animate({scrollTop: 0}, 900);
    ...
    $.get('widget/registration/sports.php', function (data, status) {
        $('#form-area').fadeOut(300, function () {
            ...
            $.post('core/techfy.php', {
                ...
                var opt = "";
                $(span).addClass('fa-soccer-ball-o').removeClass('spinner-border spinner-border-sm');
    ...
    $.get("widget/registration/documents-attachment.php", function (data, status) {
        $('#form-area').fadeOut(300, function () {
            ...
            $('#personal_photo').change(function () {
                loadPersonalPhoto($('#document-data-form .form-group:eq(0) .input-group .input-group-append button'));
            });
            ...
            $('#birth_certificate').change(function () {
                loadBirthCert($('#document-data-form .form-group:eq(1) .input-group .input-group-append button'));
            });
            ...
            $('#nid_front').change(function () {
                loadIdfront($('#document-data-form .form-group:eq(2) .input-group .input-group-append button'));
            });
            ...
            $('#nid_back').click(function () {
                loadIdback($('#document-data-form .form-group:eq(3) .input-group .input-group-append button'));
            });
            ...
            $('#student_id').change(function () {
                loadStudentid($('#document-data-form .form-group:eq(4) .input-group .input-group-append button'));
            });

            $('#document-data-form .form-group:eq(5) .input-group .input-group-append button').click(function () {
                loadHighCert($(this));
            });
            $('#high_cert').change(function () {
                loadHighCert($('#document-data-form .form-group:eq(5) .input-group .input-group-append button'));
            });
        });
